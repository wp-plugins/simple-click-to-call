...
if ( isset( $_GET['simple-click-to-call-accion'] ) && $_GET['simple-click-to-call-accion'] == 'restaurar' )
{
	...
	<div class="wrap">
		...
		<form action="<?php echo admin_url('admin.php?page=revisionalpha-simple-click-to-call/app/simple-click-to-call-settings.php'); ?>" method="POST">
...
elseif ( isset( $_POST['simple-click-to-call-accion'] ) && $_POST['simple-click-to-call-accion'] == 'restaurar' )
{
	...
	$location = admin_url('admin.php?page=revisionalpha-simple-click-to-call/app/simple-click-to-call-settings.php');
